...
func CreatevocabularyfilterHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateVocabularyFilterRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Transcribe.CreateVocabularyFilter", cfg.BaseURL)
		...
		var result models.CreateVocabularyFilterResponse
...
func CreateCreatevocabularyfilterTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Transcribe_CreateVocabularyFilter",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatevocabularyfilterHandler(cfg),
	}
}
