...
func CreatelanguagemodelHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateLanguageModelRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Transcribe.CreateLanguageModel", cfg.BaseURL)
		...
		var result models.CreateLanguageModelResponse
...
func CreateCreatelanguagemodelTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Transcribe_CreateLanguageModel",
		...
		mcp.WithString("BaseModelName", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatelanguagemodelHandler(cfg),
	}
}
