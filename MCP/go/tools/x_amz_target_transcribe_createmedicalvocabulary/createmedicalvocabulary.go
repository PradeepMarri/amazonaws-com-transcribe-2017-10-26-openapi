...
func CreatemedicalvocabularyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateMedicalVocabularyRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Transcribe.CreateMedicalVocabulary", cfg.BaseURL)
		...
		var result models.CreateMedicalVocabularyResponse
...
func CreateCreatemedicalvocabularyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Transcribe_CreateMedicalVocabulary",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatemedicalvocabularyHandler(cfg),
	}
}
