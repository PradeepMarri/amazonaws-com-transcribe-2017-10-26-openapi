...
func CreatevocabularyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateVocabularyRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=Transcribe.CreateVocabulary", cfg.BaseURL)
		...
		var result models.CreateVocabularyResponse
...
func CreateCreatevocabularyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=Transcribe_CreateVocabulary",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatevocabularyHandler(cfg),
	}
}
